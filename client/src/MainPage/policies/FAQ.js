    ...
    <>
      <section>
        ...
        <article>
          ...
          <p>
            - Consultez le lien de numéro de suivi de votre e-mail de
            confirmation qui vous permettra de savoir où se trouve votre
            commande. - Vérifiez sur votre compte que l'adresse de livraison
            ainsi et que vos coordonnées soient correctes. - si jamais vous avez
            reçu un avis de passage de la part de l'un de nos transporteurs, il
            est alors possible que le colis vous attende dans votre bureau de
            poste local ou point de retrait. - Vérifiez auprès de vos voisins
            pour vous assurer qu'ils n'aient pas récupéré le colis en votre
            absence. Parfois, l’expédition peut prendre plus de temps que prévu
            en raison de certains évènements exceptionnels et indépendants de
            notre volonté et par conséquent malencontreusement retarder les
            livraisons. Si vous estimez toujours avoir besoin d’aide après avoir

      ...
      <section className="description">
        ...
        <article className="policy">
          ...
          <p>
            ...
            délai allant jusqu'à 3 semaines selon le nombre d'articles
            commandés. La commande est ensuite expédiée depuis la France
            respectant un délai de livraison propre aux pays de destination.
          ...
          <p>
            ...
            possible de nous transmettre votre demande par email à
            contact@loveliesafrica.com et au cas où votre commande n’a pas
          ...
          <p>
            ...
            reçu. Il doit aussi être dans son emballage d'origine. Les frais de
            retour seront à vos frais dans ce cas échéant. Demandez une preuve
            d'envoi que vous devrez conserver jusqu'à ce que le retour soit
            finalisé, ainsi, vous pourrez suivre son trajet.{" "}
          </p>
          <p>
            Une fois le colis reçu, un e-mail de confirmation vous sera envoyé.
            Même si le remboursement est effectué dès réception de votre retour,
          ...
          <p>
            ...
            Danemark, Estonie, Finlande, Grèce, Hongrie, Irlande, Italie,
          ...
          <p>
            ...
            remise au transporteur. Dès lors que vous commande sera en chemin,
            vous recevrez un email avec un lien de suivi vous permettant de
            suivre son acheminement.{" "}
          </p>
          <p>
            Au cas où vous ne le receviez pas pour quelque raison que ce soit,
            connectez-vous à votre compte, choisissez la commande concernée et
            cliquez sur le bouton « Suivre mon colis ». Vous serez alors
            renvoyé(e) vers le site du transporteur qui vous informera en temps
          ...
          <p>
            ...
            commande est complète et qu'aucun produit n'est endommagé. En cas de
            doute, nous vous conseillons de refuser la livraison dans sa
          ...
          <p>
            ...
            question à l'adresse email : contact@loveliesafrica.com. Puis après
            confirmation de notre part retournez-nous l'article en suivant notre
          ...
          - Consultez le lien de numéro de suivi de votre e-mail de confirmation
          qui vous permettra de savoir où se trouve votre commande. - Vérifiez
          sur votre compte que l'adresse de livraison ainsi et que vos
          coordonnées soient correctes. - si jamais vous avez reçu un avis de
          passage de la part de l'un de nos transporteurs, il est alors possible
          que le colis vous attende dans votre bureau de poste local ou point de
          retrait. - Vérifiez auprès de vos voisins pour vous assurer qu'ils
          n'aient pas récupéré le colis en votre absence. Parfois, l’expédition
          peut prendre plus de temps que prévu en raison de certains évènements
          exceptionnels et indépendants de notre volonté et par conséquent
          malencontreusement retarder les livraisons. Si vous estimez toujours
          avoir besoin d’aide après avoir effectué ces vérifications, veuillez
          ...
          <p>
            ...
            ne vous attendiez pas à cet effet de matière ? Vous avez le droit de
            changer d'avis ! Quel que soit le motif, vous pouvez nous retourner
            la marchandise dans un délai de 14 jours à partir de la date de
            réception.{" "}
          </p>
          <p>
            ...
            emballage d'origine. Demandez une preuve d'envoi que vous devrez
            conserver jusqu'à ce que le retour soit finalisé. Ainsi, vous
            pourrez suivre son trajet. Les frais de retour dans ce cas échéant
          ...
          <p>
            ...
            Il suffira d'ajouter vos coordonnées et de régler votre commande. Si
          ...
          <p>
            ...
            matériaux et mode d'emploi d'utilisation. Si toutefois, vous avez
          ...
          <p>
            ...
            vous ne la recevez pas automatiquement sur votre boîte mail,
          ...
          <p>
            ...
            juste avant le paiement. Cliquez ensuite sur le bouton Ajouter, un
            message s'affichera afin de vous garantir la validée du code
            renseigné. La valeur de l'offre liée à ce dernier sera
            automatiquement déduite. Pour que ce code soit bien pris en compte,
          ...
          <p>
            ...
            donc pas vous faire bénéficier d'un code promotionnel a posteriori.
          ...
          <p>
            ...
            newsletters lors d'opérations promotionnelles. Certains codes sont
            exclusivement liés aux comptes mails associés et ne pourront pas
            être utilisés par d'autres clients.{" "}
          </p>
        </article>
      </section>
    </>
